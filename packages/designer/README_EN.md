...
Tip: the backend base url is configured in the `.env` file. and if you decide to use your own backend service, you need to follow the [types](https://github.com/yockii/ruomu-page/tree/master/packages/types) and [api](https://github.com/yockii/ruomu-page/tree/master/packages/api)

the api package is optional, you can use your own api implementation